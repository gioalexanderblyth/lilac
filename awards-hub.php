...
function initNotifications() {
        ...
        markAllReadBtn.addEventListener('click', async function() {
            try {
                ...
                if (response.ok) {
                    ...
                    console.error('Error marking all notifications as read:', errorData.error || 'Unknown error');
                }
            } catch (error) {
    ...
    function formatTimeAgo(datetime) {
        ...
        // Check if datetime is a numeric string or number (JavaScript equivalent of is_numeric)
        const isNumeric = (value) => !isNaN(value) && !isNaN(parseFloat(value));
        const timestamp = isNumeric(datetime) ? parseInt(datetime) : new Date(datetime).getTime();

...
<head>
    ...
    <title>Best CHED Regional Office for Internationalization Award - LILAC</title>
...
<body class="bg-background-light dark:bg-background-dark font-display text-text-light dark:text-text-dark">
    <main class="min-h-screen overflow-y-auto">
            <header class="sticky top-0 bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-sm z-30 px-6 lg:px-8 py-4 border-b border-border-light dark:border-border-dark flex justify-between items-center h-20">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-text-light dark:text-text-dark">Best CHED Regional Office for Internationalization Award</h1>
                        <p class="text-sm text-text-muted-light dark:text-text-muted-dark">Central Hub for CHED Regional Office Documents</p>
                    </div>
                </div>
            </header>
            <div class="p-6">
                <div class="max-w-7xl mx-auto">
                    <div class="mb-8 bg-gradient-to-r from-teal-50 to-teal-100 dark:from-teal-900/20 dark:to-teal-800/20 rounded-xl p-6 border border-teal-200 dark:border-teal-700">
                        <div class="flex items-center gap-4 mb-4">
                            ...
                            <div>
                                <h2 class="text-2xl font-bold text-teal-900 dark:text-teal-100">Best CHED Regional Office for Internationalization Award</h2>
                                <p class="text-teal-700 dark:text-teal-300">Recognition for exemplary CHED regional office coordination and internationalization support</p>
                            </div>
                        </div>
                        ...
                        <div class="p-6">
                            <div id="documentsList" class="space-y-4">
                                ...
                                <div id="emptyState" class="hidden text-center py-12">
                                    ...
                                    <p class="text-text-muted-light dark:text-text-muted-dark">No documents match the Best CHED Regional Office for Internationalization Award criteria.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        const AWARD_NAME = 'Best CHED Regional Office for Internationalization Award';
        const AWARD_KEYWORDS = [
            'CHED', 'regional office', 'coordination', 'CHED compliance',
            'regional internationalization support', 'regional partnership development',
            'regional resource management', 'government coordination'
        ];
        ...
        function renderDocuments() {
            ...
            container.innerHTML = filteredDocuments.map(doc => {
                ...
                return `<div class="border border-border-light dark:border-border-dark rounded-lg p-4 hover:shadow-md transition-shadow">
                    ...
                    ${matchingResult && matchingResult.recommendation ? `<div class="mt-3 p-3 bg-teal-50 dark:bg-teal-900/20 rounded-lg"><p class="text-sm text-teal-700 dark:text-teal-300"><strong>Recommendation:</strong> ${matchingResult.recommendation}</p></div>` : ''}
                </div>`;
            }).join('');
        }

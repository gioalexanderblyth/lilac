...
<head>
    ...
    <title>Sustainability Award - LILAC</title>
...
<body class="bg-background-light dark:bg-background-dark font-display text-text-light dark:text-text-dark">
    <main class="min-h-screen overflow-y-auto">
            <header class="sticky top-0 bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-sm z-30 px-6 lg:px-8 py-4 border-b border-border-light dark:border-border-dark flex justify-between items-center h-20">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-text-light dark:text-text-dark">Sustainability Award</h1>
                        <p class="text-sm text-text-muted-light dark:text-text-muted-dark">Central Hub for Sustainability Award Documents</p>
                    </div>
                </div>
            </header>
            ...
            <div class="p-6">
                <div class="max-w-7xl mx-auto">
                    <div class="mb-8 bg-gradient-to-r from-emerald-50 to-emerald-100 dark:from-emerald-900/20 dark:to-emerald-800/20 rounded-xl p-6 border border-emerald-200 dark:border-emerald-700">
                        <div class="flex items-center gap-4 mb-4">
                            ...
                            <div>
                                <h2 class="text-2xl font-bold text-emerald-900 dark:text-emerald-100">Sustainability Award</h2>
                                <p class="text-emerald-700 dark:text-emerald-300">Recognition for environmental sustainability initiatives and green campus programs</p>
                            </div>
                        </div>
                        ...
                        <div class="p-6">
                            <div id="documentsList" class="space-y-4">
                                ...
                                <div id="emptyState" class="hidden text-center py-12">
                                    ...
                                    <p class="text-text-muted-light dark:text-text-muted-dark">No documents match the Sustainability Award criteria.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        const AWARD_NAME = 'Sustainability Award';
        const AWARD_KEYWORDS = [
            'sustainability', 'environmental', 'green campus', 'climate change', 
            'renewable energy', 'waste reduction', 'carbon footprint', 'eco-friendly',
            'sustainable development', 'green initiatives', 'environmental impact'
        ];
        ...
        function renderDocuments() {
            ...
            container.innerHTML = filteredDocuments.map(doc => {
                ...
                return `<div class="border border-border-light dark:border-border-dark rounded-lg p-4 hover:shadow-md transition-shadow">
                    ...
                    ${matchingResult && matchingResult.recommendation ? `<div class="mt-3 p-3 bg-emerald-50 dark:bg-emerald-900/20 rounded-lg"><p class="text-sm text-emerald-700 dark:text-emerald-300"><strong>Recommendation:</strong> ${matchingResult.recommendation}</p></div>` : ''}
                </div>`;
            }).join('');
        }

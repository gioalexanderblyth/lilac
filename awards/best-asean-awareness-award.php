...
<head>
    ...
    <title>Best ASEAN Awareness Initiative Award - LILAC</title>
...
<body class="bg-background-light dark:bg-background-dark font-display text-text-light dark:text-text-dark">
    <main class="min-h-screen overflow-y-auto">
            <header class="sticky top-0 bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-sm z-30 px-6 lg:px-8 py-4 border-b border-border-light dark:border-border-dark flex justify-between items-center h-20">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-text-light dark:text-text-dark">Best ASEAN Awareness Initiative Award</h1>
                        <p class="text-sm text-text-muted-light dark:text-text-muted-dark">Central Hub for ASEAN Awareness Initiative Documents</p>
                    </div>
                </div>
            </header>
            <div class="p-6">
                <div class="max-w-7xl mx-auto">
                    <div class="mb-8 bg-gradient-to-r from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 rounded-xl p-6 border border-orange-200 dark:border-orange-700">
                        <div class="flex items-center gap-4 mb-4">
                            <div class="w-12 h-12 bg-orange-600 rounded-lg flex items-center justify-center">
                                <span class="material-symbols-outlined text-white text-2xl">groups</span>
                            </div>
                            <div>
                                <h2 class="text-2xl font-bold text-orange-900 dark:text-orange-100">Best ASEAN Awareness Initiative Award</h2>
                                <p class="text-orange-700 dark:text-orange-300">Recognition for outstanding ASE AN partnership networks and regional collaboration</p>
                            </div>
                        </div>
                        ...
                        <div class="p-6">
                            <div id="documentsList" class="space-y-4">
                                ...
                                <div id="emptyState" class="hidden text-center py-12">
                                    ...
                                    <p class="text-text-muted-light dark:text-text-muted-dark">No documents match the Best ASEAN Awareness Initiative Award criteria.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        const AWARD_NAME = 'Best ASEAN Awareness Initiative Award';
        const AWARD_KEYWORDS = [
            'ASEAN', 'ASEAN partnership', 'regional collaboration', 'ASEAN cultural programs',
            'regional research initiatives', 'ASEAN student exchanges', 'community ASEAN awareness',
            'Southeast Asia', 'ASEAN integration', 'regional networks'
        ];
        ...
        function renderDocuments() {
            ...
            container.innerHTML = filteredDocuments.map(doc => {
                ...
                return `<div class="border border-border-light dark:border-border-dark rounded-lg p-4 hover:shadow-md transition-shadow">
                    ...
                    ${matchingResult && matchingResult.recommendation ? `<div class="mt-3 p-3 bg-orange-50 dark:bg-orange-900/20 rounded-lg"><p class="text-sm text-orange-700 dark:text-orange-300"><strong>Recommendation:</strong> ${matchingResult.recommendation}</p></div>` : ''}
                </div>`;
            }).join('');
        }

...
<head>
    ...
    <title>Outstanding International Education Program Award - LILAC</title>
...
<body class="bg-background-light dark:bg-background-dark font-display text-text-light dark:text-text-dark">
    <main class="min-h-screen overflow-y-auto">
            <header class="sticky top-0 bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-sm z-30 px-6 lg:px-8 py-4 border-b border-border-light dark:border-border-dark flex justify-between items-center h-20">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-text-light dark:text-text-dark">Outstanding International Education Program Award</h1>
                        <p class="text-sm text-text-muted-light dark:text-text-muted-dark">Central Hub for International Education Program Documents</p>
                    </div>
                </div>
            </header>
            ...
            <div class="p-6">
                <div class="max-w-7xl mx-auto">
                    <div class="mb-8 bg-gradient-to-r from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-xl p-6 border border-green-200 dark:border-green-700">
                        <div class="flex items-center gap-4 mb-4">
                            <div class="w-12 h-12 bg-green-600 rounded-lg flex items-center justify-center">
                                <span class="material-symbols-outlined text-white text-2xl">school</span>
                            </div>
                            <div>
                                <h2 class="text-2xl font-bold text-green-900 dark:text-green-100">Outstanding International Education Program Award</h2>
                                <p class="text-green-700 dark:text-green-300">Recognition for exceptional international education programs and initiatives</p>
                            </div>
                        </div>
                        ...
                        <div class="p-6">
                            <div id="documentsList" class="space-y-4">
                                ...
                                <div id="emptyState" class="hidden text-center py-12">
                                    ...
                                    <p class="text-text-muted-light dark:text-text-muted-dark">No documents match the Outstanding International Education Program Award criteria.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        const AWARD_NAME = 'Outstanding International Education Program Award';
        const AWARD_KEYWORDS = [
            'international education', 'international programs', 'student mobility', 
            'study abroad', 'exchange programs', 'international partnerships',
            'global learning', 'cross-border education', 'international curriculum',
            'overseas programs', 'international collaboration'
        ];
        ...
        function updateStats() {
            ...
            const progressPercentage = allDocuments.length > 0 ? Math.round((eligibleCount / allDocuments.length) * 100) : 0;
        ...
        function viewDocumentDetails(awardId) {
            window.location.href = `awards.html#award-${awardId}`;
        }

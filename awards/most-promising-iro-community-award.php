...
<head>
    ...
    <title>Most Promising Regional IRO Community Award - LILAC</title>
...
<body class="bg-background-light dark:bg-background-dark font-display text-text-light dark:text-text-dark">
    <main class="min-h-screen overflow-y-auto">
            <header class="sticky top-0 bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-sm z-30 px-6 lg:px-8 py-4 border-b border-border-light dark:border-border-dark flex justify-between items-center h-20">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-text-light dark:text-text-dark">Most Promising Regional IRO Community Award</h1>
                        <p class="text-sm text-text-muted-light dark:text-text-muted-dark">Central Hub for IRO Community Award Documents</p>
                    </div>
                </div>
            </header>
            <div class="p-6">
                <div class="max-w-7xl mx-auto">
                    <div class="mb-8 bg-gradient-to-r from-pink-50 to-pink-100 dark:from-pink-900/20 dark:to-pink-800/20 rounded-xl p-6 border border-pink-200 dark:border-pink-700">
                        <div class="flex items-center gap-4 mb-4">
                            ...
                            <div>
                                <h2 class="text-2xl font-bold text-pink-900 dark:text-pink-100">Most Promising Regional IRO Community Award</h2>
                                <p class="text-pink-700 dark:text-pink-300">Recognition for outstanding IRO community building and regional networking</p>
                            </div>
                        </div>
                        ...
                        <div class="p-6">
                            <div id="documentsList" class="space-y-4">
                                ...
                                <div id="emptyState" class="hidden text-center py-12">
                                    ...
                                    <p class="text-text-muted-light dark:text-text-muted-dark">No documents match the Most Promising Regional IRO Community Award criteria.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        const AWARD_NAME = 'Most Promising Regional IRO Community Award';
        const AWARD_KEYWORDS = [
            'IRO community', 'community building', 'regional networking', 'community development',
            'collaborative initiatives', 'knowledge sharing', 'regional growth potential',
            'international relations office', 'community engagement', 'networking'
        ];
        ...
        function renderDocuments() {
            ...
            container.innerHTML = filteredDocuments.map(doc => {
                ...
                return `<div class="border border-border-light dark:border-border-dark rounded-lg p-4 hover:shadow-md transition-shadow">
                    ...
                    ${matchingResult && matchingResult.recommendation ? `<div class="mt-3 p-3 bg-pink-50 dark:bg-pink-900/20 rounded-lg"><p class="text-sm text-pink-700 dark:text-pink-300"><strong>Recommendation:</strong> ${matchingResult.recommendation}</p></div>` : ''}
                </div>`;
            }).join('');
        }

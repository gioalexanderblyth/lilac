<?php
/**
 * One-time utility: Update all existing users to admin role
 * Run once via browser: /lilac/scripts/migrations/update-users-to-admin.php
 */
session_start();
...
<body>
    <div class='container'>
        ...
        <div class='info'>
            ...
            <p><strong>Note:</strong> Users will need to log out and log back in for the changes to take effect.</p>
            <p><a href='../../index.php'>Go to Login</a> | <a href='../../dashboard.php'>Go to Dashboard</a></p>
        </div>
    </div>
</body>
</html>";
